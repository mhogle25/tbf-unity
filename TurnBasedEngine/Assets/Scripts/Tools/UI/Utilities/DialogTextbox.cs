...
namespace BF2D.UI {
    public class DialogTextbox : UIUtility {
        ...
        [SerializeField] private string dialogResponseFilesPath = string.Empty;
        ...
        public string DialogResponseFilesPath { set { this.dialogResponseFilesPath = value; } }
        ...
        public void LoadDialogResponseFiles()
        {
            ...
            BF2D.Utilities.TextFile.LoadTextFiles(this.dialogResponses, Path.Combine(Application.streamingAssetsPath, this.dialogResponseFilesPath));
        }
        #endregion
